...
app = FastAPI(
    title="Improved RAG API",
    description="Week 5 Day 2 — Enhanced RAG pipeline with adaptive chunking, dynamic retrieval, context quality validation, and hardened prompt engineering.",
    version="2.0.0"
)
